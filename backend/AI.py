...
async def process_chat(
    ...
    # elif filename.endswith((".png", ".jpg", ".jpeg")):
    #     print("up until this point it's working ")
    #     text_content = "This is an image file. Only metadata available."
    ...
    #     """
    # else:
    #     file_info = text_content[:2000] if text_content else "Unsupported file type."
    #     print("this is file_info",file_info)
    # prompt = f"""
    ...
    # If the user wants a chart or filter, return JSON instructions under keys like:
    # - "action": "filter" / "chart" / "summary"
    # - "column": "colname"
    # - "value": "x"
    # - "x_axis": "col"
    # - "y_axis": "col"
    ...
    #     model="gpt-4o-mini",
    #     messages=[
    #         {"role": "system", "content": "You are a data analysis chatbot."},
